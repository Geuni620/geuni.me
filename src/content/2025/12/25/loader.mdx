...
그럼에도 loader가 path의 이동마다 동작하도록 만들고 싶다면, [shouldRevalidate](https://reactrouter.com/6.22.0/route/should-revalidate#shouldrevalidate)를 사용해야한다.
...
이렇게하면, shouldRevalidate가 각 path마다 재검증하여 loader가 모두 동작한다.
